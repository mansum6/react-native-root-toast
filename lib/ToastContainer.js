//Todo: Show button if buttonVisible and wire up the action.
import React, {
    Component
} from 'react';
import {
...
class ToastContainer extends Component {
    ...
    render() {
        ...
        let buttonVisible=props.buttonVisible;
        let buttonCallback=props.buttonCallback;
        ...
        >
            ...
            {props.buttonVisible?(<Button title={props.buttonTitle} onPress={()=>props.onButtonPress()} />):null}   
